...
const Documentation = () => {
  const docsSchema = generateWebPageSchema({
    title: "Documentation | IdeoXai",
    description: "Browse comprehensive documentation for IdeoXai's platform, API references, guides and examples.",
    url: "https://ideox.ai/docs"
  });
  ...
  return (
    <>
      <SEO 
        title="Documentation | IdeoXai"
        description="Browse comprehensive documentation for IdeoXai's platform, API references, guides and examples."
        canonicalUrl="https://ideox.ai/docs"
        schemaMarkup={docsSchema}
      />
      <BasicPage
        title="Documentation" 
        highlightedWord="Documentation"
        description="Everything you need to build, integrate, and automate with IdeoxAI."
      >
