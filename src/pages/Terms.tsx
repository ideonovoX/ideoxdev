...
const Terms = () => {
  const termsSchema = generateWebPageSchema({
    title: "Terms of Service | IdeoXai",
    description: "Read the Terms of Service for IdeoXai's AI automation platform and services.",
    url: "https://ideox.ai/terms"
  });
  ...
  return (
    <>
      <SEO 
        title="Terms of Service | IdeoXai"
        description="Read the Terms of Service for IdeoXai's AI automation platform and services."
        canonicalUrl="https://ideox.ai/terms"
      ...
      >
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <section className="mb-6">
            ...
            <p>
              These Terms of Service constitute a legally binding agreement made between you and IdeoxAI, concerning your access to and use of our website and platform. You agree that by accessing the platform, you have read, understood, and agree to be bound by all of these Terms of Service.
            </p>
            <p>
              IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF SERVICE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE PLATFORM AND YOU MUST DISCONTINUE USE IMMEDIATELY.
            </p>
          </section>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-bold mb-3">User Representations</h2>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-bold mb-3">User Registration</h2>
            <p>
          ...
          <section className="mb-6">
            <h2 className="text-2xl font-bold mb-3">Fees and Payment</h2>
            <p>
            ...
            <p>
              We bill you through an online billing account for purchases made via the platform. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in U.S. dollars.
            </p>
            <p>
          ...
          <section className="mb-6">
            ...
            <p>
              If you are unsatisfied with our services, please email us at ai@ideox.ai.
            </p>
          </section>
